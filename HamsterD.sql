...
--시퀀스 생성
 ...
 CREATE SEQUENCE SEQ_STUDENT_NO; -- TB_SCHEDULE STUDENT_NO 컬럼 SEQ (스케줄 번호)
...
-- ALTER TABLE TB_MEMBER MODIFY BIRTH DATE(date_format(BIRTH(),'YYYY-MM-DD'));
 ...
 INSERT INTO TB_MEMBER (MEMBER_NO, ID, PASSWORD, NAME, BIRTH, GENDER, PHONE, ADDR, ACADEMY_NAME, STUDENT_NO) 
 VALUES(SEQ_MEMBER_NO.NEXTVAL, '1121', '1111', '윤종빈', '23/10/18', 'MAN', '11111232', '경기광주', 'KH', SEQ_STUDENT_NO.NEXTVAL);
