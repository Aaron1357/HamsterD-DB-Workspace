...
CREATE TABLE TB_STUDYGROUP( -- 스터디 그룹 테이블 생성
    ...
    groupAcademy VARCHAR2(50),
    groupContent VARCHAR2(50),
    GROUPIMAGE VARCHAR2(50)
);
...
--ALTER TABLE TB_IN_COMMENT ADD CONSTRAINT COMMENT_CASCADE FOREIGN KEY (COMMENT_NO) REFERENCES TB_COMMENT(COMMENT_NO) 

--ALTER TABLE TB_IN_COMMENT ADD FOREIGN KEY (COMMENT_NO) REFERENCES TB_COMMENT(COMMENT_NO) ON DELETE CASCADE;
--ALTER TABLE TB_COMMENT ADD FOREIGN KEY (POST_NO) REFERENCES TB_POST(POST_NO) ON DELETE CASCADE;
...
--ALTER TABLE TB_IN_COMMENT DROP CONSTRAINT SYS_C0010366;
